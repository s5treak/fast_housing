...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center" style="color:#fff;">{{ __('Register') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                                      <input type="radio" name="role" value="FastRep" class="account-type-radio"/>
                                    <label for="FastRep/House Owner" class=""><i class="icon-material-outline-account-circle"></i>FastRep</label>
                                
                                
                                    <input type="radio" name="role" value="Customer" class="account-type-radio"/>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" style="background-color:#D45600; border-color:#D45600;" class="btn btn-primary">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
